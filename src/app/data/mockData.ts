  ...
  keyLearnings: [
    {
      ...
      quotes: [
        ...
        {
          id: "q3a",
          text: "I keep losing context when moving between services. A persistent nav would save me so much time.",
        ...
        {
          id: "q3b",
          text: "The sidebar should stay visible. I need it to orient myself, especially when I'm jumping between networking and compute.",
          participantName: "Emily Torres",
          transcriptId: "T-005",
          timestamp: "11:20",
        },
        {
          id: "q3c",
          text: "Without consistent navigation, I feel like I'm starting from scratch every time I switch sections.",
        ...
        {
          id: "q3d",
          text: "I rely on the left nav to know where I am. When it disappears mid-task, it's really disorienting.",
          participantName: "Anika Gupta",
          transcriptId: "T-007",
          timestamp: "07:33",
        },
      ],
    },
    {
      ...
      quotes: [
        ...
        {
          id: "q5a",
          text: "My dashboard shows a bunch of metrics I never look at. I want to pin what matters to my role.",
          participantName: "Marcus Johnson",
          transcriptId: "T-002",
          timestamp: "25:10",
        },
        {
          id: "q5b",
          text: "As a DevOps lead, I need deployment status and error rates front and center, not generic usage graphs.",
          participantName: "Emily Torres",
          transcriptId: "T-005",
          timestamp: "16:44",
        },
        {
          id: "q5c",
          text: "I spend the first five minutes of my day hunting for the numbers I actually need. That's wasted time.",
          participantName: "James Wright",
          transcriptId: "T-006",
          timestamp: "09:18",
        },
        {
          id: "q5d",
          text: "Different teams have different priorities. The dashboard should reflect that automatically.",
          participantName: "Anika Gupta",
          transcriptId: "T-007",
          timestamp: "21:05",
        },
    ...
    },
    {
      ...
      quotes: [
        ...
        {
          id: "q8a",
          text: "The service list is overwhelming. I just want my top five services visible without scrolling.",
          participantName: "Sarah Chen",
          transcriptId: "T-001",
          timestamp: "28:12",
        },
        {
          id: "q8b",
          text: "Everything in the switcher looks the same. There's no grouping, no hierarchy. It's just a wall of text.",
          participantName: "Emily Torres",
          transcriptId: "T-005",
          timestamp: "13:50",
        },
    ...
    },
    {
      ...
      quotes: [
        ...
        {
          id: "q10a",
          text: "When I'm three levels deep in a VCN config, the breadcrumb trail is the only thing telling me where I am.",
          participantName: "Priya Patel",
          transcriptId: "T-003",
          timestamp: "35:20",
        },
        {
          id: "q10b",
          text: "I finished the task much faster when I could see the breadcrumb path. It gave me confidence I was in the right place.",
          participantName: "David Kim",
          transcriptId: "T-004",
          timestamp: "40:08",
        },
        {
          id: "q10c",
          text: "Breadcrumbs remove the fear of getting lost. I can explore deeper pages knowing I can always trace back.",
          participantName: "Emily Torres",
          transcriptId: "T-005",
          timestamp: "29:55",
        },
        {
          id: "q10d",
          text: "Without breadcrumbs, I'd just use the back button repeatedly and hope I end up in the right place.",
          participantName: "James Wright",
          transcriptId: "T-006",
          timestamp: "33:17",
        },
